...
export default function Explore() {
  const {
    timeLeft, budgetLeft, preserved,
    selection, selectionKind, popupPos,
    onSelection, onImageSelection, onClearSelection,
    save, dismiss,
  } = usePreservation();
